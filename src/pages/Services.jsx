...
<section className="w-full bg-gradient-to-b from-pink-100 via-white to-white py-16 px-4 flex flex-col items-center text-center">
  ...
  <a
    ...
    className="bg-pink-600 text-white px-8 py-4 rounded-full text-base shadow-xl hover:bg-pink-700 transition-all duration-300 transform hover:scale-105 animate-fade-in delay-200"
  >
    Solicitar Turno
  </a>
</section>
